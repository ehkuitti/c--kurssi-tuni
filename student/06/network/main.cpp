...
void print_command(
        const OrganizationMap& underlings_by_name,
        const std::string& boss_id,
        ...
        const std::string& boss_id)
{
    ...
    for (const auto& underling : underlings_by_name.at(boss_id))
    {
        max_subtree_depth = std::max(
            max_subtree_depth,
            depth_command(underlings_by_name, underling));
    }
...
int main()
{
    ...
    while(true){
        ...
        if(command == "S" or command == "s"){
            ...
            std::cout << count_command(underlings_by_name, id) << "\n";
            ...
            std::cout << depth_command(underlings_by_name, id) << "\n";
